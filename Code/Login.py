...
# bg_lbl=tk.Label(root, width=800,height=600)
...
title.place(x=400,y=150,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=250,y=230)
...
button1 = tk.Button(label_l1, text="Home", command=home, width=10, height=1,font=('times 15 bold underline'),bd=0, bg="#006400", fg="white")
button1.place(x=1185, y=50)

button2 = tk.Button(label_l1, text="About us",command=about,width=7, height=1,font=('times 15 bold underline'), bd=0,bg="#006400", fg="white")
button2.place(x=150, y=50)

button4 = tk.Button(label_l1, text="Contact us", command=con, width=7, height=1,font=('times 15 bold underline'),bd=0,bg="#006400", fg="white")
button4.place(x=260, y=50)
...
# button1 = tk.Button(root, text="Home", command=log, width=10, height=1,font=('times 15 bold underline'),bd=0, bg="#006400", fg="white")
