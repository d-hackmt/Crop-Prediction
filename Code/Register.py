...
button4 = tk.Button(root, text="Home", command=home, width=7, height=1,font=('times', 15, ' bold'),bg="#006400", fg="white")
button4.place(x=240, y=250)

button4 = tk.Button(root, text="Exit", command=window, width=7, height=1,font=('times', 15, ' bold'),bg="#006400", fg="white")
button4.place(x=240, y=320)
